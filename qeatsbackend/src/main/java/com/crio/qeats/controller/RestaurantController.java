...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(@Valid GetRestaurantsRequest getRestaurantsRequest) {
    ...
    GetRestaurantsResponse getRestaurantsResponse;
      ...
      if(searchFor != null && !searchFor.isEmpty()) {
        System.out.println(getRestaurantsRequest+" RestaurantRepositoryServiceinside findRestaurantsBySearchQuery");
      ...
      System.out.println("Time taken by function at Controller is : " +(endTimeInMillis-startTimeInMillis));
      System.out.println(getRestaurantsRequest +" Controller");
  ...
  // public ResponseEntity<Restaurant> getRestaurantMenu(@PathVariable int id) {

  //   log.info("getRestaurants called with {}", id);
  ...
  //     .
  //     log.info("getRestaurants returned {}", id);
  //     //CHECKSTYLE:ON
